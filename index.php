...
<title>Home</title>
<meta name="description"  content="Get the perfect Video Animation - or any animation in over 90 categories" />
...
<section class="section-padding testimonials testimonials-custom-add wow fadeInDown" data-wow-delay="0.2s">
  ...
  <div class="row">
        <div class="col-md-12">
                ...
                <p>We rated 8.9 out of 10  served 300+ satisfied customers</p>
     ...
     <div>
        ...
        <div class="row set-height nopaddres">
          ...
          <!-- <video autoplay loop class="">
            ...
            <img src="assets/images/2d-character.png">
        </div>
          ...
          <div class="user_aplha-video">
            <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/graphics-animation.mp4" type="video/mp4" />
            </video> -->
            <img src="assets/images/2d-graphics2.png">
        </div>
          <div class="VideoTextSer">
        ...
        <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/explainer-animation.mp4" type="video/mp4" />
            </video> -->
            <img src="assets/images/explainer-video3.png">
        </div>
            <div class="VideoTextSer">
         ...
         <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/whiteboard-animation.mp4" type="video/mp4" />
            </video> -->
            <img src="assets/images/whiteboard4.png">
        </div>
          <div class="VideoTextSer">
        ...
        <div class="row set-height nopaddres">
         ...
         <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/3d-animation.mp4" type="video/mp4" />
            </video> -->
            <img src="assets/images/3d-animation5.png">
        </div>
            <div class="VideoTextSer">
          ...
          <div class="user_aplha-video">
            <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/typography-animation.mp4" type="video/mp4" />
            </video> -->
...
<!-- <section class="servicesSectionnew">
  <div class="container">
    ...
    <ul>
       <li><img src="assets/images/animationicon1.png"><span>Promotional <br>videos</span></li>
       <li><img src="assets/images/animationicon1.png"><span>2D/3D  <br>video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>whiteboard  <br>video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>Product  <br>video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>Music animated  <br>video</span></li>
    </ul>
  </div>
</section> -->
...
<!-- <section class="servics_slide">
  ...
  <h2>Services</h2>
   <div class="fullimg">
     ...
     <ul class="thmbsnav">
       <li><img src="assets/images/animationicon1.png"><span>Hand sketch video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>Promotional videos</span></li>
       <li><img src="assets/images/animationicon1.png"><span>2D/3D video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>whiteboard video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>Product video</span></li>
       <li><img src="assets/images/animationicon1.png"><span>Music animated video</span></li>
    </ul>
</section> -->
