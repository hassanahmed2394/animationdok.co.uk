                    ...
                    <div class="col-md-12">
                      <article class="services-list">
                        <ul class="what-ul hidden-sm">
                                 ...
                                 <li class="discuss-icon"><i class="fa fa-comment"></i> <a href="javascript:;" class="what-ul-a" onclick="setButtonURL();">
...
<div class="tabs tabs-logodesign current row m-app-slider no-gutters for-works-load">
                  ...
                  <div class="row">
                   ...
                   <a class="callus" href="tel:442033181217"><i class="fa fa-phone"></i>+44 203 3181 217</a></h3>
    ...
    <div class="row">
      ...
      <div class="col-lg-10 offset-lg-1">
        <div class="wrap">
          ...
          <span>Let's create something together   <a href="tel:++442033181217">+44 203 3181 217</a></span>
        </div>
      </div>
    </div>
  </div>
